<template>
    <footer class="bg-white relative border-t-[1.5px] border-[#0f172a1a]">
        <div class="max-w-[1280px] mx-auto min-[1024px]:px-[32px]">
                    ...
                    <ul class="flex items-center justify-end gap-1.5 sm:-mr-0 sm:gap-3 z-10 sm:w-40 md:w-60 drop-shadow">
                        <li>
                            <a href="https://twitter.com/" rel="noopener noreferrer" target="_blank"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    aria-hidden="true" role="img" class="icon icon-leading fill-current text-[#1d9bf0] hover:scale-[1.2] transition-all duration-[0.3s] ease-in-out delay-[0ms]"
                                    data-v-d64ec27c="" style="" width="1em" height="1em" viewBox="0 0 24 24"
                                    data-v-40670dad="">
                                    <path fill="currentColor"
                        ...
                        <li>
                            <a href="tel:+84332006710" rel="noopener noreferrer" target="_blank"
                                class="app-button pv-WjEgmP pc-lW04s6 !p-0 u-text-gray-900 focus-visible:ring-2"
                                title="Call Us" data-v-d64ec27c="">
                                <svg xmlns="http://www.w3.org/2000/svg" class="fill-current text-[#4bd964] hover:scale-[1.2] transition-all duration-[0.3s] ease-in-out delay-[0ms]" id="phone"
                        ...
                        <li>
                            <a href="https://www.facebook.com/" rel="noopener noreferrer" target="_blank"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" class="fill-current text-[#1a77f2] hover:scale-[1.2] transition-all duration-[0.3s] ease-in-out delay-[0ms]"
                                    data-name="Layer 1" width="1em" height="1em" viewBox="0 0 24 24" id="facebook">
                                    <path
