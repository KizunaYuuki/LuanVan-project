    ...
    <main>
        ...
        <div class="min-h-[80vh] pt-8">
                ...
                <div class="m-4">
                    ...
                    <Combobox>
                        <div class="relative mt-1 z-[1] hover:border-[#9aa0a6] border rounded-md border-gray-50">
                            <div
                                class="relative w-full cursor-default overflow-hidden rounded-lg bg-white text-left shadow-md focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 focus-visible:ring-offset-2 focus-visible:ring-offset-teal-300 sm:text-sm">
                                <input @change="handleChangeWeight()" @input="handleChangeWeight" v-model="filter.weight"
                                    type="number"
                                    class="w-72 border-none py-2 pl-3 pr-10 text-sm leading-5 text-gray-500 focus:ring-0 outline-none h-11"
            ...
            <div class="rounded-lg m-[16px] flex lg:justify-start mx-auto max-w-5xl lg:pt-[24px] flex-wrap justify-center">
                ...
                <!-- provider filter -->
                <div class="w-56">
                    <Listbox v-model="providerSelected" class="m-2 ml-[8px]">
                        <div class="relative">
                            <ListboxButton
                                class="hover:border-[#9aa0a6] border relative w-full cursor-default rounded-lg border-gray-50 bg-white py-2 pl-3 pr-10 text-left shadow-md focus:outline-none focus-visible:border-indigo-500 focus-visible:ring-2 focus-visible:ring-white/75 focus-visible:ring-offset-2 focus-visible:ring-offset-orange-300 sm:text-sm">
                                <span class="block truncate">{{ providerSelected.name }}</span>
                                <span class="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-2">
                                    <ChevronUpDownIcon class="h-5 w-5 text-gray-400" aria-hidden="true" />
                                </span>
                            </ListboxButton>
                            ...
                            <transition leave-active-class="transition duration-100 ease-in" leave-from-class="opacity-100"
                                ...
                                <ListboxOptions
                                    ...
                                    <ListboxOption v-slot="{ active, selected }" v-for="providerFilter in providerFilters"
                                        ...
                                        <li @click="providerFilterHandle(providerFilter)" class="m-1 rounded-md" :class="[
                                            active ? 'bg-sky-400 text-white' : 'text-gray-900',
                                            'relative cursor-default select-none py-2 pl-10 pr-4',
                                        ]">
                                            <span :class="[
                ...
                <!-- service type filter -->
                <div class="">
                    <Listbox v-model="serviceTypeSelected" class="m-2 ml-[8px] z-10">
                        <div class="relative">
                            <ListboxButton
                                class="hover:border-[#9aa0a6] border relative w-full cursor-default rounded-lg border-gray-50 bg-white py-2 pl-3 pr-10 text-left shadow-md focus:outline-none focus-visible:border-indigo-500 focus-visible:ring-2 focus-visible:ring-white/75 focus-visible:ring-offset-2 focus-visible:ring-offset-orange-300 sm:text-sm">
                                <span class="block truncate">{{ serviceTypeSelected.name }}</span>
                                <span class="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-2">
                                    <ChevronUpDownIcon class="h-5 w-5 text-gray-400" aria-hidden="true" />
                                </span>
                            </ListboxButton>
                            ...
                            <transition leave-active-class="transition duration-100 ease-in" leave-from-class="opacity-100"
                                ...
                                <ListboxOptions
                                    ...
                                    <ListboxOption v-slot="{ active, selected }"
                                        ...
                                        <li @click="serviceTypeFilterHandle(serviceTypeFilter)" class="m-1 rounded-md"
                                            :class="[
                                                active ? 'bg-sky-400 text-white' : 'text-gray-900',
                                                'relative cursor-default select-none py-2 pl-10 pr-4',
                                            ]">
            ...
            <div v-else>
                ...
                <div class="mx-auto max-w-5xl lg:block hidden">
                    ...
                    <!-- content -->
                    <div v-show="services.length !== 0" class="mt-[1rem] flow-root z-0">
...
const serviceTypeSelected = ref(serviceTypeFilters.value[0])
const providerSelected = ref(providerFilters.value[0])
...
const priceFilterHandle = async (selected) => {
    ...
    if (timeFilters.value[0].name !== timeSelected.value.name) {
        ...
        if (selected.name === priceFilters.value[0].name) {
            ...
            changeDistrictFrom();
            changeDistrictTo();
            providerFilterHandle(providerSelected.value);
            serviceTypeFilterHandle(serviceTypeSelected.value);
            return;
        } else {
...
const providerFilterHandle = async (selected) => {
    if (selected.name === providerFilters.value[0].name) {
        services.value = filterServices.value;
    }
    else {
        services.value = providerFilter(filterServices.value, selected);
    }
    services.value = serviceTypeFilter(services.value, serviceTypeSelected.value);
};

function providerFilter(servicesData, selected) {
    if (selected?.name !== providerFilters.value[0].name) {
        let result = servicesData.filter((element) => element.provider_name === selected.name);
        return result;
    }
    else {
        return servicesData;
...
const serviceTypeFilterHandle = async (selected) => {
    if (selected.name === providerFilters.value[0].name) {
        services.value = filterServices.value;
    }
    else {
        services.value = serviceTypeFilter(filterServices.value, selected);
    }
    services.value = providerFilter(services.value, providerSelected.value);
};

function serviceTypeFilter(servicesData, selected) {
    if (selected?.name !== serviceTypeFilters.value[0].name) {
        let result = servicesData.filter((element) => element.service_types_name === selected.name);
        return result;
    }
    else {
        return servicesData;
...
const getInfoReviewsAxios = async () => {
    ...
    if (data) {
        ...
        // Tao rootServices và filterServices
        filterServices.value = services.value;
        rootServices.value = services.value;
        console.log(services.value);
    }
