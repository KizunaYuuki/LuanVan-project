<template>
    <div
        class="xl:pl-60 pt-14 min-h-screen w-screen transition-position lg:w-auto bg-gray-50 dark:bg-slate-800 dark:text-slate-100">
        <nav
        ...
        <div class="flex lg:items-stretch xl:max-w-6xl xl:mx-auto">
            <div class="flex flex-1 items-stretch h-14">
                <div
                    class="flex lg:hidden text-black hover:text-blue-500 py-2 px-3 items-center cursor-pointer dark:text-white dark:hover:text-slate-400">
                ...
                <div
                    class="hidden lg:flex xl:hidden text-black hover:text-blue-500 py-2 px-3 items-center cursor-pointer dark:text-white dark:hover:text-slate-400">
                    <span class="inline-flex justify-center items-center w-6 h-6"><svg viewBox="0 0 24 24" width="24"
                            height="24" class="inline-block">
                            <path fill="currentColor" d="M3,6H21V8H3V6M3,11H21V13H3V11M3,16H21V18H3V16Z"></path>
                        </svg></span></div>
                <div
                    class="flex text-black hover:text-blue-500 my-2 mx-3 items-center cursor-pointer dark:text-white dark:hover:text-slate-400">
                    <div class="relative"><input placeholder="Search (ctrl+k)" type="text"
                            class="px-3 py-2 max-w-full focus:ring focus:outline-none border-gray-700 rounded w-full dark:placeholder-gray-400 h-12 border-0 bg-transparent"><!---->
                    </div>
                </div>
            </div>
            <div class="flex-none items-stretch flex h-14 lg:hidden">
                <div
                    class="flex text-black hover:text-blue-500 py-2 px-3 items-center cursor-pointer dark:text-white dark:hover:text-slate-400">
                    <span class="inline-flex justify-center items-center w-6 h-6"><svg viewBox="0 0 24 24" width="24"
                            height="24" class="inline-block">
                            <path fill="currentColor"
            ...
            <div
                ...
                <div
                    class="block lg:flex items-center relative cursor-pointer text-black dark:text-white dark:hover:text-slate-400 hover:text-blue-500 lg:py-2 lg:px-3">
                    <div
                        ...
                        <!----><span class="inline-flex justify-center items-center w-6 h-6 transition-colors"><svg
                                ...
                                <path fill="currentColor" d="M3,6H21V8H3V6M3,11H21V13H3V11M3,16H21V18H3V16Z"></path>
                            </svg></span><span class="px-2 transition-colors">Sample menu</span><span
                ...
                <div
                    ...
                    <div
                        ...
                        <!----><span class="px-2 transition-colors">John Doe</span><span
                            class="inline-flex justify-center items-center w-6 h-6 hidden lg:inline-flex transition-colors"><svg
                                viewBox="0 0 24 24" width="16" height="16" class="inline-block">
                                <path fill="currentColor"
                                    d="M7.41,8.58L12,13.17L16.59,8.58L18,10L12,16L6,10L7.41,8.58Z"></path>
                    ...
                    <div
                        ...
                        <a
                            ...
                            <div class="flex items-center"><!----><span
                                    ...
                                    </svg></span><span class="px-2 transition-colors">My Profile</span><!----></div>
                            <!---->
                        </a>
                        <div
                            class="block lg:flex items-center relative cursor-pointer text-black dark:text-white dark:hover:text-slate-400 hover:text-blue-500 py-2 px-3">
                ...
                <div
                    class="block lg:flex items-center relative cursor-pointer text-black dark:text-white dark:hover:text-slate-400 hover:text-blue-500 py-2 px-3 lg:w-16 lg:justify-center">
                    <div class="flex items-center"><!----><span
                            class="inline-flex justify-center items-center w-6 h-6 transition-colors"><svg
                                viewBox="0 0 24 24" width="16" height="16" class="inline-block">
                                <path fill="currentColor"
                            ...
                            </svg></span><span class="px-2 transition-colors lg:hidden">Light/Dark</span><!----></div>
                    <!---->
                </div><a
                    class="block lg:flex items-center relative cursor-pointer text-black dark:text-white dark:hover:text-slate-400 hover:text-blue-500 py-2 px-3 lg:w-16 lg:justify-center"
                    href="https://github.com/justboil/admin-one-vue-tailwind" target="_blank">
                    <div class="flex items-center"><!----><span
                            class="inline-flex justify-center items-center w-6 h-6 transition-colors"><svg
                                viewBox="0 0 24 24" width="16" height="16" class="inline-block">
                                <path fill="currentColor"
                            ...
                            </svg></span><span class="px-2 transition-colors lg:hidden">GitHub</span><!----></div>
                    <!---->
                </a><a
                    class="block lg:flex items-center relative cursor-pointer text-black dark:text-white dark:hover:text-slate-400 hover:text-blue-500 py-2 px-3 lg:w-16 lg:justify-center"
                    href="https://github.com/justboil/admin-one-react-tailwind" target="_blank">
                    <div class="flex items-center"><!----><span
                            class="inline-flex justify-center items-center w-6 h-6 transition-colors"><svg
                                viewBox="0 0 24 24" width="16" height="16" class="inline-block">
                                <path fill="currentColor"
                            ...
                            </svg></span><span class="px-2 transition-colors lg:hidden">React version</span><!---->
                    </div><!---->
                </a>
                <div
                    class="block lg:flex items-center relative cursor-pointer text-black dark:text-white dark:hover:text-slate-400 hover:text-blue-500 py-2 px-3 lg:w-16 lg:justify-center">
            ...
            <div class="aside-scrollbars-gray flex-1 overflow-y-auto overflow-x-hidden">
                <ul>
                    <li><a aria-current="page"
                            class="router-link-active router-link-exact-active flex cursor-pointer py-3 text-gray-300 hover:text-white dark:text-slate-300 dark:hover:text-white"><span
                                class="inline-flex justify-center items-center w-16 h-6 flex-none font-bold text-white"><svg
                                ...
                                class="grow text-ellipsis line-clamp-1 pr-12 font-bold text-white">Dashboard</span><!----></a><!---->
                    </li>
                    <li><a
                            class="flex cursor-pointer py-3 text-gray-300 hover:text-white dark:text-slate-300 dark:hover:text-white"><span
                                ...
                                class="grow text-ellipsis line-clamp-1 pr-12">Tables</span><!----></a><!----></li>
                    <li><a
                            class="flex cursor-pointer py-3 text-gray-300 hover:text-white dark:text-slate-300 dark:hover:text-white"><span
                                class="inline-flex justify-center items-center w-16 h-6 flex-none"><svg
                                    viewBox="0 0 24 24" width="18" height="18" class="inline-block">
                                ...
                                class="grow text-ellipsis line-clamp-1 pr-12">Forms</span><!----></a><!----></li>
                    <li><a
                            class="flex cursor-pointer py-3 text-gray-300 hover:text-white dark:text-slate-300 dark:hover:text-white"><span
                                class="inline-flex justify-center items-center w-16 h-6 flex-none"><svg
                                    viewBox="0 0 24 24" width="18" height="18" class="inline-block">
                                ...
                                class="grow text-ellipsis line-clamp-1 pr-12">UI</span><!----></a><!----></li>
                    <li><a
                            class="flex cursor-pointer py-3 text-gray-300 hover:text-white dark:text-slate-300 dark:hover:text-white"><span
                                class="inline-flex justify-center items-center w-16 h-6 flex-none"><svg
                                    viewBox="0 0 24 24" width="18" height="18" class="inline-block">
                                ...
                                class="grow text-ellipsis line-clamp-1 pr-12">Responsive</span><!----></a><!----></li>
                    <li><a
                            class="flex cursor-pointer py-3 text-gray-300 hover:text-white dark:text-slate-300 dark:hover:text-white"><span
                                class="inline-flex justify-center items-center w-16 h-6 flex-none"><svg
                                    viewBox="0 0 24 24" width="18" height="18" class="inline-block">
                                ...
                                class="grow text-ellipsis line-clamp-1 pr-12">Styles</span><!----></a><!----></li>
                    <li><a
                            class="flex cursor-pointer py-3 text-gray-300 hover:text-white dark:text-slate-300 dark:hover:text-white"><span
                                class="inline-flex justify-center items-center w-16 h-6 flex-none"><svg
                                    viewBox="0 0 24 24" width="18" height="18" class="inline-block">
                                ...
                                class="grow text-ellipsis line-clamp-1 pr-12">Profile</span><!----></a><!----></li>
                    <li><a
                            class="flex cursor-pointer py-3 text-gray-300 hover:text-white dark:text-slate-300 dark:hover:text-white"><span
                                class="inline-flex justify-center items-center w-16 h-6 flex-none"><svg
                                    viewBox="0 0 24 24" width="18" height="18" class="inline-block">
                                ...
                                class="grow text-ellipsis line-clamp-1 pr-12">Login</span><!----></a><!----></li>
                    <li><a
                            class="flex cursor-pointer py-3 text-gray-300 hover:text-white dark:text-slate-300 dark:hover:text-white"><span
                                class="inline-flex justify-center items-center w-16 h-6 flex-none"><svg
                                    viewBox="0 0 24 24" width="18" height="18" class="inline-block">
                                ...
                                class="grow text-ellipsis line-clamp-1 pr-12">Error</span><!----></a><!----></li>
                    <li><a
                            class="flex cursor-pointer py-3 text-gray-300 hover:text-white dark:text-slate-300 dark:hover:text-white"><span
                                class="inline-flex justify-center items-center w-16 h-6 flex-none"><svg
                                    viewBox="0 0 24 24" width="18" height="18" class="inline-block">
                                ...
                                </svg></span><span class="grow text-ellipsis line-clamp-1">Dropdown</span><span
                                class="inline-flex justify-center items-center w-12 h-6 flex-none"><svg
                                    viewBox="0 0 24 24" width="16" height="16" class="inline-block">
                        ...
                        <ul class="bg-gray-700/50 hidden">
                            <li><a
                                    class="flex cursor-pointer py-3 px-6 text-sm text-gray-300 hover:text-white dark:text-slate-300 dark:hover:text-white"><!----><span
                                        class="grow text-ellipsis line-clamp-1 pr-12">Item One</span><!----></a><!---->
                            </li>
                            <li><a
                                    class="flex cursor-pointer py-3 px-6 text-sm text-gray-300 hover:text-white dark:text-slate-300 dark:hover:text-white"><!----><span
                                        class="grow text-ellipsis line-clamp-1 pr-12">Item Two</span><!----></a><!---->
                            </li>
                        </ul>
                    </li>
                    <li><a href="https://github.com/justboil/admin-one-vue-tailwind" target="_blank"
                            class="flex cursor-pointer py-3 text-gray-300 hover:text-white dark:text-slate-300 dark:hover:text-white"><span
                                class="inline-flex justify-center items-center w-16 h-6 flex-none"><svg
                                    viewBox="0 0 24 24" width="18" height="18" class="inline-block">
                                    <path fill="currentColor"
                                ...
                                class="grow text-ellipsis line-clamp-1 pr-12">GitHub</span><!----></a><!----></li>
                    <li><a href="https://github.com/justboil/admin-one-react-tailwind" target="_blank"
                            class="flex cursor-pointer py-3 text-gray-300 hover:text-white dark:text-slate-300 dark:hover:text-white"><span
                                class="inline-flex justify-center items-center w-16 h-6 flex-none"><svg
                                    viewBox="0 0 24 24" width="18" height="18" class="inline-block">
                                    <path fill="currentColor"
                                ...
                                </svg></span><span class="grow text-ellipsis line-clamp-1 pr-12">React
                                version</span><!----></a><!----></li>
                </ul>
            </div>
            <ul>
                <li><a
                        class="flex cursor-pointer py-3 border-blue-600 dark:border-blue-500 ring-blue-300 dark:ring-blue-700 bg-blue-600 dark:bg-blue-500 text-white hover:bg-blue-700 hover:border-blue-700 hover:dark:bg-blue-600 hover:dark:border-blue-600"><span
                            class="inline-flex justify-center items-center w-16 h-6 flex-none"><svg viewBox="0 0 24 24"
                                width="18" height="18" class="inline-block">
                                <path fill="currentColor"
                                    d="M16,17V14H9V10H16V7L21,12L16,17M14,2A2,2 0 0,1 16,4V6H14V4H5V20H14V18H16V20A2,2 0 0,1 14,22H5A2,2 0 0,1 3,20V4A2,2 0 0,1 5,2H14Z">
                                </path>
                            </svg></span><span
                            class="grow text-ellipsis line-clamp-1 pr-12">Logout</span><!----></a><!----></li>
            </ul>
        </div>
    </aside>
    <div class="flex z-30 items-center flex-col justify-center overflow-hidden fixed inset-0" style="display: none;">
        <div
    ...
    <section class="p-6 xl:max-w-6xl xl:mx-auto">
        <section class="mb-6 flex items-center justify-between">
            <div class="flex items-center justify-start"><span
                ...
                href="https://github.com/justboil/admin-one-vue-tailwind" target="_blank" disabled="false"><span
                    class="inline-flex justify-center items-center w-6 h-6"><svg viewBox="0 0 24 24" width="16"
                        height="16" class="inline-block">
                        <path fill="currentColor"
                            d="M12,2A10,10 0 0,0 2,12C2,16.42 4.87,20.17 8.84,21.5C9.34,21.58 9.5,21.27 9.5,21C9.5,20.77 9.5,20.14 9.5,19.31C6.73,19.91 6.14,17.97 6.14,17.97C5.68,16.81 5.03,16.5 5.03,16.5C4.12,15.88 5.1,15.9 5.1,15.9C6.1,15.97 6.63,16.93 6.63,16.93C7.5,18.45 8.97,18 9.54,17.76C9.63,17.11 9.89,16.67 10.17,16.42C7.95,16.17 5.62,15.31 5.62,11.5C5.62,10.39 6,9.5 6.65,8.79C6.55,8.54 6.2,7.5 6.75,6.15C6.75,6.15 7.59,5.88 9.5,7.17C10.29,6.95 11.15,6.84 12,6.84C12.85,6.84 13.71,6.95 14.5,7.17C16.41,5.88 17.25,6.15 17.25,6.15C17.8,7.5 17.45,8.54 17.35,8.79C18,9.5 18.38,10.39 18.38,11.5C18.38,15.32 16.04,16.16 13.81,16.41C14.17,16.72 14.5,17.33 14.5,18.26C14.5,19.6 14.5,20.68 14.5,21C14.5,21.27 14.66,21.59 15.17,21.5C19.14,20.16 22,16.42 22,12A10,10 0 0,0 12,2Z">
                        </path>
                    </svg></span><span class="px-1">Star on GitHub</span></a>
        </section>
                    ...
                    <div class="justify-between items-center flex mb-3">
                        <div class="flex items-center justify-center">
                            <div
                                ...
                                <span class="inline-flex justify-center items-center w-4 h-4 mr-1"><svg
                                        viewBox="0 0 24 24" width="14" height="14" class="inline-block">
                                        <path fill="currentColor"
            ...
            <div class="rounded-2xl flex-col dark:bg-slate-900/70 bg-white flex">
                <div class="flex-1 p-6">
                    ...
                    <div class="justify-between items-center flex">
                        <div class="flex items-center justify-center">
                            <div>
                                <h3 class="text-lg leading-tight text-gray-500 dark:text-slate-400">Sales</h3>
                                <h1 class="text-3xl leading-tight font-semibold">
                                    <div>$7,770</div>
                                </h1>
                            </div>
            ...
            <div class="rounded-2xl flex-col dark:bg-slate-900/70 bg-white flex">
                <div class="flex-1 p-6">
                    ...
                    <div class="justify-between items-center flex">
                        <div class="flex items-center justify-center">
                            <div>
                                <h3 class="text-lg leading-tight text-gray-500 dark:text-slate-400">Performance</h3>
                                <h1 class="text-3xl leading-tight font-semibold">
                                    <div>256%</div>
                                </h1>
                            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            <div class="flex flex-col justify-between">
                <div
                    class="rounded-2xl flex-col dark:bg-slate-900/70 hover:shadow-lg transition-shadow duration-500 bg-white flex mb-6 last:mb-0">
                    <div class="flex-1 p-6">
                        <div class="justify-between items-center block md:flex">
                            <div class="flex items-center justify-center mb-6 md:mb-0">
                                <div class="justify-start items-center block md:flex">
                                    <div class="flex items-center justify-center mb-6 md:mb-0"><span
                                            class="inline-flex justify-center items-center w-12 h-12 rounded-full text-emerald-500 bg-gray-50 dark:bg-slate-800 md:mr-6"><svg
                                                viewBox="0 0 24 24" width="24" height="24" class="inline-block">
                                                <path fill="currentColor"
                                    ...
                                    <div class="flex items-center justify-center">
                                        <div class="text-center space-y-1 md:text-left md:mr-6">
                                            ...
                                            <p class="text-gray-500 dark:text-slate-400"><b>3 days ago</b> via Turcotte
                                            </p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="flex-1 p-6">
                        <div class="justify-between items-center block md:flex">
                            <div class="flex items-center justify-center mb-6 md:mb-0">
                                <div class="justify-start items-center block md:flex">
                                    <div class="flex items-center justify-center mb-6 md:mb-0"><span
                                            class="inline-flex justify-center items-center w-12 h-12 rounded-full text-blue-500 bg-gray-50 dark:bg-slate-800 md:mr-6"><svg
                                                viewBox="0 0 24 24" width="24" height="24" class="inline-block">
                                                <path fill="currentColor"
                                    ...
                                    <div class="flex items-center justify-center">
                                        <div class="text-center space-y-1 md:text-left md:mr-6">
                                            ...
                                            <p class="text-gray-500 dark:text-slate-400"><b>3 days ago</b> via Murazik -
                                                Graham</p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="flex-1 p-6">
                        <div class="justify-between items-center block md:flex">
                            <div class="flex items-center justify-center mb-6 md:mb-0">
                                <div class="justify-start items-center block md:flex">
                                    <div class="flex items-center justify-center mb-6 md:mb-0"><span
                                            class="inline-flex justify-center items-center w-12 h-12 rounded-full text-yellow-500 bg-gray-50 dark:bg-slate-800 md:mr-6"><svg
                                                viewBox="0 0 24 24" width="24" height="24" class="inline-block">
                                                <path fill="currentColor"
                                    ...
                                    <div class="flex items-center justify-center">
                                        <div class="text-center space-y-1 md:text-left md:mr-6">
                                            ...
                                            <p class="text-gray-500 dark:text-slate-400"><b>5 days ago</b> via Fahey -
                                                Keebler</p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="flex-1 p-6">
                        <div class="justify-between items-center block md:flex">
                            <div class="flex items-center justify-center mb-6 md:mb-0">
                                <div class="justify-start items-center block md:flex">
                                    <div class="flex items-center justify-center mb-6 md:mb-0"><span
                                            class="inline-flex justify-center items-center w-12 h-12 rounded-full text-red-500 bg-gray-50 dark:bg-slate-800 md:mr-6"><svg
                                                viewBox="0 0 24 24" width="24" height="24" class="inline-block">
                                                <path fill="currentColor"
                                    ...
                                    <div class="flex items-center justify-center">
                                        <div class="text-center space-y-1 md:text-left md:mr-6">
                                            ...
                                            <p class="text-gray-500 dark:text-slate-400"><b>7 days ago</b> via Collier -
                                                Hintz</p>
                                        </div>
                                    </div>
                                </div>
                ...
                <div
                    ...
                    <div class="flex-1 p-6">
                        <div class="justify-between items-center block md:flex">
                                ...
                                <div class="justify-start items-center block md:flex">
                                    ...
                                    <div class="flex items-center justify-center">
                                        <div class="text-center md:text-left overflow-hidden">
                                            ...
                                            <p class="text-gray-500 dark:text-slate-400">Mar 3, 2021 @ percy64</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="flex items-center justify-center">
                                <div
                                    class="inline-flex items-center capitalize leading-none text-sm border rounded-full py-1.5 px-4 bg-emerald-500 border-emerald-500 text-white">
                                ...
                                <div class="justify-start items-center block md:flex">
                                    ...
                                    <div class="flex items-center justify-center">
                                        <div class="text-center md:text-left overflow-hidden">
                                            ...
                                            <p class="text-gray-500 dark:text-slate-400">Dec 1, 2021 @ dare.concepcion
                                            </p>
                                        </div>
                                    </div>
                                </div>
                ...
                <div
                    ...
                    <div class="flex-1 p-6">
                        <div class="justify-between items-center block md:flex">
                                ...
                                <div class="justify-start items-center block md:flex">
                                    ...
                                    <div class="flex items-center justify-center">
                                        <div class="text-center md:text-left overflow-hidden">
                                            ...
                                            <p class="text-gray-500 dark:text-slate-400">May 18, 2021 @ geovanni.kessler
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="flex items-center justify-center">
                                <div
                                    class="inline-flex items-center capitalize leading-none text-sm border rounded-full py-1.5 px-4 bg-yellow-500 border-yellow-500 text-white">
                                    <span class="inline-flex justify-center items-center w-4 h-4 mr-2"><svg
                                            viewBox="0 0 24 24" width="16" height="16" class="inline-block">
                                            <path fill="currentColor" d="M22,12L18,8V11H3V13H18V16L22,12Z"></path>
                                        </svg></span><span>49%</span></div>
                            </div>
                        </div>
                    </div><!---->
                </div>
                <div
                    ...
                    <div class="flex-1 p-6">
                        <div class="justify-between items-center block md:flex">
                                ...
                                <div class="justify-start items-center block md:flex">
                                    ...
                                    <div class="flex items-center justify-center">
                                        <div class="text-center md:text-left overflow-hidden">
                                            ...
                                            <p class="text-gray-500 dark:text-slate-400">May 4, 2021 @
                                                macejkovic.dashawn</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="flex items-center justify-center">
                                <div
                                    class="inline-flex items-center capitalize leading-none text-sm border rounded-full py-1.5 px-4 bg-red-500 border-red-500 text-white">
                                    <span class="inline-flex justify-center items-center w-4 h-4 mr-2"><svg
                                            viewBox="0 0 24 24" width="16" height="16" class="inline-block">
                                            <path fill="currentColor"
        ...
        <div
            ...
            <div><a class="inline-flex justify-center items-center whitespace-nowrap focus:outline-none transition-colors focus:ring duration-150 border cursor-pointer rounded-full border-white ring-gray-200 dark:ring-gray-500 bg-white text-black hover:bg-gray-100 py-2 px-6"
                    href="https://github.com/justboil/admin-one-vue-tailwind" target="_blank" disabled="false"><span
                        class="inline-flex justify-center items-center w-6 h-6"><svg viewBox="0 0 24 24" width="16"
                            height="16" class="inline-block">
                            <path fill="currentColor"
                        ...
                        </svg></span><span class="px-2">GitHub</span></a></div>
        </div>
        <section class="pt-6 mb-6 flex items-center justify-between">
            <div class="flex items-center justify-start"><span
                    class="inline-flex justify-center items-center w-6 h-6 mr-2"><svg viewBox="0 0 24 24" width="20"
                        height="20" class="inline-block">
                        <path fill="currentColor"
                ...
                <h1 class="text-2xl leading-tight">Trends overview</h1>
            </div><button
        ...
        <div class="rounded-2xl flex-col dark:bg-slate-900/70 bg-white flex mb-6">
            <div class="flex-1 p-6">
                <div><canvas class="h-96" style="display: block; box-sizing: border-box; height: 384px; width: 1042px;"
                        width="2084" height="768"></canvas></div>
            </div><!---->
        </div>
        <section class="pt-6 mb-6 flex items-center justify-between">
            <div class="flex items-center justify-start"><span
                ...
                <h1 class="text-2xl leading-tight">Clients</h1>
            </div><button
                class="inline-flex justify-center items-center whitespace-nowrap focus:outline-none transition-colors focus:ring duration-150 border cursor-pointer rounded border-white dark:border-slate-900 ring-gray-200 dark:ring-gray-500 bg-white text-black dark:bg-slate-900 dark:text-white hover:bg-gray-100 hover:dark:bg-slate-800 p-1"
                type="button"><span class="inline-flex justify-center items-center w-6 h-6"><svg viewBox="0 0 24 24"
                        width="16" height="16" class="inline-block">
                    ...
                    <div class="rounded-2xl flex-col dark:bg-slate-900 bg-white flex shadow-lg max-h-modal w-11/12 md:w-3/5 lg:w-2/5 xl:w-4/12 z-50"
                        ...
                        <div class="flex-1 p-6">
                            <div class="flex items-center justify-between mb-3">
                                <h1 class="text-2xl">Sample modal</h1>
                            </div>
                            <div class="space-y-3">
                        ...
                        <footer class="p-6">
                            <div class="flex items-center justify-start flex-wrap -mb-3"><button
                                    ...
                                    type="button"><!----><span class="px-2">Done</span></button><!----></div>
                        </footer>
                    </div>
                </div>
                <div class="flex z-50 items-center flex-col justify-center overflow-hidden fixed inset-0"
                    ...
                    <div class="rounded-2xl flex-col dark:bg-slate-900 bg-white flex shadow-lg max-h-modal w-11/12 md:w-3/5 lg:w-2/5 xl:w-4/12 z-50"
                        ...
                        <div class="flex-1 p-6">
                            <div class="flex items-center justify-between mb-3">
                                <h1 class="text-2xl">Please confirm</h1><button
                        ...
                        <footer class="p-6">
                            <div class="flex items-center justify-start flex-wrap -mb-3"><button
                                    ...
                                    type="button"><!----><span class="px-2">Done</span></button><button
                                    ...
                                    type="button"><!----><span class="px-2">Cancel</span></button></div>
                        </footer>
                    </div>
                </div><!---->
                <table>
                    ...
                    <tbody>
                        <tr><!---->
                            <td class="border-b-0 lg:w-6 before:hidden">
                                <div class="w-24 h-24 mx-auto lg:w-6 lg:h-6"><img
                                        src="https://avatars.dicebear.com/api/avataaars/Howell-Hand.svg"
                                        alt="Howell Hand"
                                        class="rounded-full block h-auto w-full max-w-full bg-gray-100 dark:bg-slate-800">
                                </div>
                            ...
                            <td data-label="Progress" class="lg:w-32"><progress class="flex w-2/5 self-center lg:w-full"
                                    max="100" value="70">70</progress></td>
                            <td data-label="Created" class="lg:w-1 whitespace-nowrap"><small
                                    class="text-gray-500 dark:text-slate-400" title="Mar 3, 2021">Mar 3, 2021</small>
                            </td>
                            <td class="before:hidden lg:w-1 whitespace-nowrap">
                                <div class="flex items-center justify-start lg:justify-end flex-nowrap -mb-3"><button
                        ...
                        <tr><!---->
                            <td class="border-b-0 lg:w-6 before:hidden">
                                <div class="w-24 h-24 mx-auto lg:w-6 lg:h-6"><img
                                        src="https://avatars.dicebear.com/api/avataaars/Hope-Howe.svg" alt="Hope Howe"
                                        class="rounded-full block h-auto w-full max-w-full bg-gray-100 dark:bg-slate-800">
                                </div>
                            </td>
                            ...
                            <td data-label="Progress" class="lg:w-32"><progress class="flex w-2/5 self-center lg:w-full"
                                    max="100" value="68">68</progress></td>
                            <td data-label="Created" class="lg:w-1 whitespace-nowrap"><small
                                    class="text-gray-500 dark:text-slate-400" title="Dec 1, 2021">Dec 1, 2021</small>
                            </td>
                            <td class="before:hidden lg:w-1 whitespace-nowrap">
                                <div class="flex items-center justify-start lg:justify-end flex-nowrap -mb-3"><button
                                        class="inline-flex justify-center items-center whitespace-nowrap focus:outline-none transition-colors focus:ring duration-150 border cursor-pointer rounded border-blue-600 dark:border-blue-500 ring-blue-300 dark:ring-blue-700 bg-blue-600 dark:bg-blue-500 text-white hover:bg-blue-700 hover:border-blue-700 hover:dark:bg-blue-600 hover:dark:border-blue-600 p-1 mr-3 last:mr-0 mb-3"
                        ...
                        <tr><!---->
                            ...
                            <td data-label="Progress" class="lg:w-32"><progress class="flex w-2/5 self-center lg:w-full"
                                    max="100" value="49">49</progress></td>
                            <td data-label="Created" class="lg:w-1 whitespace-nowrap"><small
                                    class="text-gray-500 dark:text-slate-400" title="May 18, 2021">May 18, 2021</small>
                            </td>
                            <td class="before:hidden lg:w-1 whitespace-nowrap">
                                <div class="flex items-center justify-start lg:justify-end flex-nowrap -mb-3"><button
                                        class="inline-flex justify-center items-center whitespace-nowrap focus:outline-none transition-colors focus:ring duration-150 border cursor-pointer rounded border-blue-600 dark:border-blue-500 ring-blue-300 dark:ring-blue-700 bg-blue-600 dark:bg-blue-500 text-white hover:bg-blue-700 hover:border-blue-700 hover:dark:bg-blue-600 hover:dark:border-blue-600 p-1 mr-3 last:mr-0 mb-3"
                        ...
                        <tr><!---->
                            ...
                            <td data-label="Progress" class="lg:w-32"><progress class="flex w-2/5 self-center lg:w-full"
                                    max="100" value="38">38</progress></td>
                            <td data-label="Created" class="lg:w-1 whitespace-nowrap"><small
                                    class="text-gray-500 dark:text-slate-400" title="May 4, 2021">May 4, 2021</small>
                            </td>
                            <td class="before:hidden lg:w-1 whitespace-nowrap">
                                <div class="flex items-center justify-start lg:justify-end flex-nowrap -mb-3"><button
                                        class="inline-flex justify-center items-center whitespace-nowrap focus:outline-none transition-colors focus:ring duration-150 border cursor-pointer rounded border-blue-600 dark:border-blue-500 ring-blue-300 dark:ring-blue-700 bg-blue-600 dark:bg-blue-500 text-white hover:bg-blue-700 hover:border-blue-700 hover:dark:bg-blue-600 hover:dark:border-blue-600 p-1 mr-3 last:mr-0 mb-3"
                        ...
                        <tr><!---->
                            ...
                            <td data-label="Progress" class="lg:w-32"><progress class="flex w-2/5 self-center lg:w-full"
                                    max="100" value="38">38</progress></td>
                            <td data-label="Created" class="lg:w-1 whitespace-nowrap"><small
                                    class="text-gray-500 dark:text-slate-400" title="Mar 27, 2021">Mar 27, 2021</small>
                            </td>
                            <td class="before:hidden lg:w-1 whitespace-nowrap">
                                <div class="flex items-center justify-start lg:justify-end flex-nowrap -mb-3"><button
                                        class="inline-flex justify-center items-center whitespace-nowrap focus:outline-none transition-colors focus:ring duration-150 border cursor-pointer rounded border-blue-600 dark:border-blue-500 ring-blue-300 dark:ring-blue-700 bg-blue-600 dark:bg-blue-500 text-white hover:bg-blue-700 hover:border-blue-700 hover:dark:bg-blue-600 hover:dark:border-blue-600 p-1 mr-3 last:mr-0 mb-3"
                    ...
                    <div class="justify-between items-center block md:flex">
                        <div class="flex items-center justify-center mb-6 md:mb-0">
                            <div class="flex items-center justify-start flex-wrap -mb-3"><button
                                    ...
                                    type="button"><!----><span class="px-2">1</span></button><button
                                    class="inline-flex justify-center items-center whitespace-nowrap focus:outline-none transition-colors focus:ring duration-150 border cursor-pointer rounded border-white dark:border-slate-900 ring-gray-200 dark:ring-gray-500 bg-white text-black dark:bg-slate-900 dark:text-white hover:bg-gray-100 hover:dark:bg-slate-800 text-sm p-1 mr-3 last:mr-0 mb-3"
                                    type="button"><!----><span class="px-2">2</span></button><button
                                    class="inline-flex justify-center items-center whitespace-nowrap focus:outline-none transition-colors focus:ring duration-150 border cursor-pointer rounded border-white dark:border-slate-900 ring-gray-200 dark:ring-gray-500 bg-white text-black dark:bg-slate-900 dark:text-white hover:bg-gray-100 hover:dark:bg-slate-800 text-sm p-1 mr-3 last:mr-0 mb-3"
                                    type="button"><!----><span class="px-2">3</span></button><button
                                    class="inline-flex justify-center items-center whitespace-nowrap focus:outline-none transition-colors focus:ring duration-150 border cursor-pointer rounded border-white dark:border-slate-900 ring-gray-200 dark:ring-gray-500 bg-white text-black dark:bg-slate-900 dark:text-white hover:bg-gray-100 hover:dark:bg-slate-800 text-sm p-1 mr-3 last:mr-0 mb-3"
                                    type="button"><!----><span class="px-2">4</span></button></div>
                        </div>
                        <div class="flex items-center justify-center"><small>Page 1 of 4</small></div>
                    </div>
                </div>
            </div><!---->
        </div>
    ...
    <footer class="py-2 px-6 xl:max-w-6xl xl:mx-auto">
        <div class="justify-between items-center block md:flex">
            <div class="flex items-center justify-center mb-6 md:mb-0">
                <div class="text-center md:text-left"><b>©2023, <a href="https://justboil.me/"
                            target="_blank">JustBoil.me</a>.</b> Get more with <a
                        href="https://tailwind-vue.justboil.me/" target="_blank" class="text-blue-600">Premium
                        version</a></div>
            </div>
            <div class="flex items-center justify-center">
                <div class="md:py-2"><a href="https://justboil.me"><svg xmlns="http://www.w3.org/2000/svg" width="250"
                            height="100" viewBox="0 0 250 100" class="w-auto h-8 md:h-6">
                            <path fill="currentColor"
