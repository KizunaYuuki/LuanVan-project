        ...
        <div>
            ...
            <!-- <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                <div class="flex flex-col justify-between">
                    <div class="rounded-2xl flex-col dark:bg-slate-900/70 bg-white flex mb-6 last:mb-0">
                        <div class="flex-1 p-6">
                                    ...
                                    <div class="justify-start items-center block md:flex">
                                        ...
                                        <div class="flex items-center justify-center">
                                            <div class="text-center space-y-1 md:text-left md:mr-6">
                                                ...
                                                <p class="text-gray-500 dark:text-slate-400"><b>3 days ago</b> via
                                                    Turcotte</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="justify-start items-center block md:flex">
                                        ...
                                        <div class="flex items-center justify-center">
                                            <div class="text-center space-y-1 md:text-left md:mr-6">
                                                ...
                                                <p class="text-gray-500 dark:text-slate-400"><b>7 days ago</b> via
                                                    Collier - Hintz</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="justify-start items-center block md:flex">
                                        ...
                                        <div class="flex items-center justify-center">
                                            <div class="text-center md:text-left overflow-hidden">
                                                ...
                                                <p class="text-gray-500 dark:text-slate-400">Mar 3, 2023 @ percy64</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="justify-start items-center block md:flex">
                                        ...
                                        <div class="flex items-center justify-center">
                                            <div class="text-center md:text-left overflow-hidden">
                                                ...
                                                <p class="text-gray-500 dark:text-slate-400">Dec 1, 2023 @
                                                    dare.concepcion</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="justify-start items-center block md:flex">
                                        ...
                                        <div class="flex items-center justify-center">
                                            <div class="text-center md:text-left overflow-hidden">
                                                ...
                                                <p class="text-gray-500 dark:text-slate-400">May 18, 2023 @
                                                    geovanni.kessler</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="justify-start items-center block md:flex">
                                        ...
                                        <div class="flex items-center justify-center">
                                            <div class="text-center md:text-left overflow-hidden">
                                                ...
                                                <p class="text-gray-500 dark:text-slate-400">May 4, 2023 @
            ...
            <section class="pt-6 mb-6 flex items-center justify-between">
                <div class="flex items-center justify-start"><span
                    ...
                    <h1 class="text-3xl leading-tight">Tổng quan về xu hướng</h1>
                </div><button
            ...
            <div class="rounded-2xl flex-col dark:bg-slate-900/70 bg-white flex mb-6">
                <div class="flex-1 p-6">
                    <div><canvas class="h-96" width="2066" height="768"
                            style="display: block; box-sizing: border-box; height: 384px; width: 1033px;"></canvas>
                    </div>
                </div>
            </div>
            ...
            <div
                ...
                <div class="justify-between items-center block md:flex">
                    ...
                    <div class="flex items-center justify-center"><button
                            class="inline-flex justify-center items-center whitespace-nowrap focus:outline-none transition-colors focus:ring duration-150 border cursor-pointer rounded-full border-white ring-gray-200 dark:ring-gray-500 bg-white text-black hover:bg-gray-100 p-1"
