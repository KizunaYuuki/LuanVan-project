    ...
    <main v-show="service">
        <div>
            <div class="py-6 font-sans">
                <!-- Product info -->
                <div
                    class="mx-auto max-w-2xl pb-16 pt-10 lg:grid lg:max-w-5xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:pb-4 lg:pt-16 lg:px-8 px-1 bg-white rounded-md">
                    <div class="lg:col-span-2 lg:pr-8">
                        <h1 class="text-2xl font-bold tracking-tight text-gray-700 sm:text-3xl">{{
                    ...
                    <div class="mt-4 lg:row-span-3 lg:mt-0">
                        ...
                        <div>
                            ...
                            <p v-else-if="service?.price" class="text-3xl tracking-tight text-gray-700">
                            ...
                            <div class="flex items-center">
                                <div class="flex items-center">
                                    <StarIcon v-for="rating in [0, 1, 2, 3, 4]" :key="rating"
                                        :class="[reviewsCal.average > rating ? 'text-gray-700' : 'text-gray-200', 'h-5 w-5 flex-shrink-0']"
                                        aria-hidden="true" />
                                </div>
                                ...
                                <RadioGroup v-model="selectedSize" class="mt-4">
                                    ...
                                    <div class="grid grid-cols-4 gap-4 sm:grid-cols-8 lg:grid-cols-4">
                                        <RadioGroupOption as="template" v-for="size in product.sizes" :key="size.name"
                                            ...
                                            <div
                                                :class="[size.inStock ? 'cursor-pointer bg-white text-gray-700 shadow-sm' : 'cursor-not-allowed bg-gray-50 text-gray-200', active ? 'ring-2 ring-indigo-500' : '', 'group relative flex items-center justify-center rounded-md border py-3 px-4 text-sm font-medium uppercase hover:bg-gray-50 focus:outline-none sm:flex-1 sm:py-6']">
                        ...
                        <div v-show="relatedProducts" class="p-2 bg-gray-100 rounded-lg">
                            <h2 class="text-2xl p-4 font-medium text-gray-700">Dịch vụ tương tự</h2>
                    ...
                    <div class="py-10 lg:col-span-2 lg:col-start-1 lg:pb-16 lg:pr-8 lg:pt-6">
                        ...
                        <div v-if="service?.description">
                            <h2 class="font-[500]">Mô tả</h2>
                            <div v-if="service" class="space-y-6 mt-4">
                                <p class="text-base text-gray-700">{{ service.description }}</p>
                            </div>
                        </div>

                        <!-- Bình luận - Đánh giá -->
                        <section id="reviews" class="mt-[32px] pt-[32px] border-t border-[#0096fa]/75">
                            <div class="text-[#757575]">
                                <div class="mb-[16px]">
                                    <h1 class="text-[24px] font-[500] py-[8px] flex justify-between items-center">Xếp hạng
                                        ...
                                        <button @click="openReviewForm()"
                                            ...
                                            <span class="inline-flex md:hidden items-center">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    fill="currentColor" class="bi bi-pen" viewBox="0 0 16 16">
                                                    <path
                                                        d="m13.498.795.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001zm-.644.766a.5.5 0 0 0-.707 0L1.95 11.756l-.764 3.057 3.057-.764L14.44 3.854a.5.5 0 0 0 0-.708l-1.585-1.585z" />
                                    ...
                                    <span class="text-[18px] text-[#757575] font-[500] inline-flex py-[8px]">
                                        ...
                                        <span class="ml-4 overflow-hidden text-ellipsis whitespace-nowrap font-sans">
                                            ({{
                                    ...
                                    <div v-for="review in reviews">
                                        ...
                                        <div class="flex items-center">
                                            <span>
                                                <div class="flex items-center">
                                                    <StarIcon v-for="rating in [0, 1, 2, 3, 4]" :key="rating"
                                                        :class="[review.rate > rating ? 'text-gray-700' : 'text-gray-200', 'h-5 w-5 flex-shrink-0']"
                                                        aria-hidden="true" />
                                                </div>
                                            </span>
                                            <span class="ml-3">
                                ...
                                <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                                    <div class="">
                                        <div class="mt-3 text-center sm:mt-0 sm:text-left">
                                            <DialogTitle as="h3" class="text-[24px] font-semibold leading-6 text-gray-700">
                                                    ...
                                                    <div class="space-y-12">
                                                        <div class="mt-7 grid grid-cols-1 gap-x-6 gap-y-2 sm:grid-cols-6">
                                                            <div class="col-span-full flex items-center">
                                                                ...
                                                                <p class="ml-4">Đánh giá từ 1 đến 5 sao</p>
                                                            </div>

                                                            <div class="col-span-full">
                                                                <label for="about"
                                                                    class="block text-base font-medium leading-6 text-gray-700">Bình
                                                                    luận</label>
                                                                <div class="mt-2">
                                                                    <textarea v-model="review.comment" id="about"
                                                                        name="about" rows="3"
                                                                        class="pl-[14px] block w-full rounded-md border-0 py-1.5 text-gray-700 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                                                </div>
