<template>
    ...
    <main>
        <div class="min-h-[80vh] pt-8">
            ...
            <div
                ...
                <div class="m-4">
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <button
                            @click="resetFromData(priceSelect, timeSelect, serviceTypeSelect?.name, providerSelect?.name, '', '', inputFilter.province_to?.Name, inputFilter.district_to?.Name, weightSelect, [])"
                            ...
                            <TransitionRoot leave="transition ease-in duration-100" leaveFrom="opacity-100"
                                ...
                                <ComboboxOptions
                                    ...
                                    <ComboboxOption v-for="province_from in filteredProvinceFrom" as="template"
                                        ...
                                        <li @click="handleFilterByProvinceFrom(priceSelect, timeSelect, serviceTypeSelect?.name, providerSelect?.name, province_from.Name, '', inputFilter.province_to?.Name, inputFilter.district_to?.Name, weightSelect, province_from)"
                            ...
                            <TransitionRoot leave="transition ease-in duration-100" leaveFrom="opacity-100"
                                ...
                                <ComboboxOptions
                                    ...
                                    <ComboboxOption v-for="district_from in filteredDistrictFrom" as="template"
                                        ...
                                        <li @click="handleFilterByDistrictFrom(priceSelect, timeSelect, serviceTypeSelect?.name, providerSelect?.name, inputFilter.province_from?.Name, district_from.Name, inputFilter.province_to?.Name, inputFilter.district_to?.Name, weightSelect, province_from)"
                                            class="relative cursor-default select-none py-2 pl-10 pr-4" :class="{
                                                'bg-sky-400 text-white': active,
                                                'text-gray-900': !active,
                                            }">
                ...
                <div class="m-4">
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <button
                            @click="resetToData(priceSelect, timeSelect, serviceTypeSelect?.name, providerSelect?.name, inputFilter.province_from?.Name, inputFilter.district_from?.Name, '', '', weightSelect, [])"
                            class="inline-flex justify-center items-center whitespace-nowrap focus:outline-none transition-colors focus:ring duration-150 border cursor-pointer rounded border-white ring-gray-200 bg-gray-50 text-black hover:bg-gray-100 p-1"
                            type="button" title="Tải lại">
                            <span class="inline-flex justify-center items-center w-6 h-6">
                                <svg viewBox="0 0 24 24" width="16" height="16" class="inline-block">
                            ...
                            <TransitionRoot leave="transition ease-in duration-100" leaveFrom="opacity-100"
                                ...
                                <ComboboxOptions
                                    ...
                                    <ComboboxOption v-for="province_to in filteredProvinceTo" as="template"
                                        ...
                                        <li @click="handleFilterByProvinceTo(priceSelect, timeSelect, serviceTypeSelect?.name, providerSelect?.name, inputFilter.province_from?.Name, inputFilter.district_from?.Name, province_to.Name, '', weightSelect, province_to)"
                                            class="relative cursor-default select-none py-2 pl-10 pr-4" :class="{
                                                'bg-sky-400 text-white': active,
                                                'text-gray-900': !active,
                                            }">
                            ...
                            <TransitionRoot leave="transition ease-in duration-100" leaveFrom="opacity-100"
                                ...
                                <ComboboxOptions
                                    ...
                                    <ComboboxOption v-for="district_to in filteredDistrictTo" as="template"
                                        ...
                                        <li @click="handleFilterByDistrictTo(priceSelect, timeSelect, serviceTypeSelect?.name, providerSelect?.name, inputFilter.province_from?.Name, inputFilter.district_from?.Name, inputFilter.province_to?.Name, district_to?.Name, weightSelect, province_from)"
                                            class="relative cursor-default select-none py-2 pl-10 pr-4" :class="{
                                                'bg-sky-400 text-white': active,
                                                'text-gray-900': !active,
                                            }">
            ...
            <!-- Filters -->
            <div class="rounded-lg m-[16px] flex lg:justify-center mx-auto max-w-5xl lg:pt-[24px] flex-wrap justify-center">
                <!-- Title -->
                            ...
                            <transition leave-active-class="transition duration-100 ease-in" leave-from-class="opacity-100"
                                ...
                                <ListboxOptions
                                    ...
                                    <ListboxOption v-slot="{ active, selected }" v-for="priceFilter in priceFilters"
                                        ...
                                        <li @click="handleFilter(priceFilter, timeSelect, serviceTypeSelect?.name, providerSelect?.name, inputFilter.province_from?.Name, inputFilter.district_from?.Name, inputFilter.province_to?.Name, inputFilter.district_to?.Name, weightSelect)"
                            ...
                            <transition leave-active-class="transition duration-100 ease-in" leave-from-class="opacity-100"
                                ...
                                <ListboxOptions
                                    ...
                                    <ListboxOption v-slot="{ active, selected }" v-for="timeFilter in timeFilters"
                                        ...
                                        <li @click="handleFilter(priceSelect, timeFilter, serviceTypeSelect?.name, providerSelect?.name, inputFilter.province_from?.Name, inputFilter.district_from?.Name, inputFilter.province_to?.Name, inputFilter.district_to?.Name, weightSelect)"
                                            class="m-1 rounded-md" :class="[
                                                active ? 'bg-sky-400 text-white' : 'text-gray-900',
                                                'relative cursor-default select-none py-2 pl-10 pr-4',
                                            ]">
                ...
                <!-- SERVICE TYPE FILTER -->
                <div class="w-80">
                    <Listbox v-model="serviceTypeSelect" class="m-2 ml-[8px]">
                        <div class="relative">
                            <ListboxButton
                                class="hover:border-[#9aa0a6] border relative w-full cursor-default rounded-lg border-gray-50 bg-white py-2 pl-3 pr-10 text-left shadow-md focus:outline-none focus-visible:border-indigo-500 focus-visible:ring-2 focus-visible:ring-white/75 focus-visible:ring-offset-2 focus-visible:ring-offset-orange-300 sm:text-sm">
                                <span class="block truncate">{{ serviceTypeSelect.name }}</span>
                                <span class="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-2">
                                    <ChevronUpDownIcon class="h-5 w-5 text-gray-400" aria-hidden="true" />
                                </span>
                            </ListboxButton>
                            ...
                            <transition leave-active-class="transition duration-100 ease-in" leave-from-class="opacity-100"
                                ...
                                <ListboxOptions
                                    ...
                                    <ListboxOption v-slot="{ active, selected }"
                                        v-for="serviceTypeFilter in serviceTypeFilters" :key="serviceTypeFilter.name"
                                        :value="serviceTypeFilter" as="template">
                                        <li @click="handleFilter(priceSelect, timeSelect, serviceTypeFilter?.name, providerSelect?.name, inputFilter.province_from?.Name, inputFilter.district_from?.Name, inputFilter.province_to?.Name, inputFilter.district_to?.Name, weightSelect)"
                                            class="m-1 rounded-md" :class="[
                                                active ? 'bg-sky-400 text-white' : 'text-gray-900',
                                                'relative cursor-default select-none py-2 pl-10 pr-4',
                                            ]">
                            ...
                            <transition leave-active-class="transition duration-100 ease-in" leave-from-class="opacity-100"
                                ...
                                <ListboxOptions
                                    ...
                                    <ListboxOption v-slot="{ active, selected }" v-for="providerFilter in providerFilters"
                                        ...
                                        <li @click="handleFilter(priceSelect, timeSelect, serviceTypeSelect?.name, providerFilter?.name, inputFilter.province_from?.Name, inputFilter.district_from?.Name, inputFilter.province_to?.Name, inputFilter.district_to?.Name, weightSelect)"
                                            class="m-1 rounded-md" :class="[
                                                active ? 'bg-sky-400 text-white' : 'text-gray-900',
                                                'relative cursor-default select-none py-2 pl-10 pr-4',
                                            ]">
                ...
                <!-- WEIGHT FILTER -->
                <div class="w-60">
                    <Listbox v-model="weightSelect" class="m-2 ml-[8px]">
                        <div class="relative">
                            <ListboxButton
                                class="hover:border-[#9aa0a6] border relative w-full cursor-default rounded-lg border-gray-50 bg-white py-2 pl-3 pr-10 text-left shadow-md focus:outline-none focus-visible:border-indigo-500 focus-visible:ring-2 focus-visible:ring-white/75 focus-visible:ring-offset-2 focus-visible:ring-offset-orange-300 sm:text-sm">
                                <span class="block truncate">{{ weightSelect.name }}</span>
                                <span class="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-2">
                                    <ChevronUpDownIcon class="h-5 w-5 text-gray-400" aria-hidden="true" />
                                </span>
                            </ListboxButton>
                            ...
                            <transition leave-active-class="transition duration-100 ease-in" leave-from-class="opacity-100"
                                ...
                                <ListboxOptions
                                    class="absolute mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black/5 focus:outline-none sm:text-sm z-10">
                                    <ListboxOption v-slot="{ active, selected }" v-for="weightFilter in weightFilters"
                                        :key="weightFilter.name" :value="weightFilter" as="template">
                                        <li @click="handleFilter(priceSelect, timeSelect, serviceTypeSelect?.name, providerSelect?.name, inputFilter.province_from?.Name, inputFilter.district_from?.Name, inputFilter.province_to?.Name, inputFilter.district_to?.Name, weightFilter)"
                                            class="m-1 rounded-md" :class="[
                                                active ? 'bg-sky-400 text-white' : 'text-gray-900',
                                                'relative cursor-default select-none py-2 pl-10 pr-4',
                                            ]">
            ...
            <!-- LOADING -->
            <div v-if="loading" class="mx-auto max-w-5xl">
            ...
            <div v-else>
                ...
                <div class="mx-auto max-w-5xl lg:block hidden">
                    ...
                    <!-- content -->
                    <div v-show="filtered.length !== 0" class="mt-[1rem] flow-root z-0">
                    ...
                    <div v-show="filtered.length === 0"
                        ...
                        <div class="font-[600]">
                            <h1 class=" text-gray-500">Chưa có Tìm thấy dịch vụ nào phù hợp! Thay đổi bộ lọc có thể giúp ích
                            </h1>
                        </div>
                    </div>
                </div>
                ...
                <div class="lg:hidden">
                    <div class="no-scrollbar grid grid-cols-2 gap-x-1 gap-y-1">
                        <template v-for="service in filtered">
...
const serviceTypeSelect = ref(serviceTypeFilters.value[0]);
...
// LỌC THEO PRICE
const handleFilter = function (priceSelected, timeSelected, serviceTypeName, providerName, province_from, district_from, province_to, district_to, weight) {
    ...
    if (weight?.min || !(weight?.min && weight?.max)) {
...
const serviceTypeFilter = function (data, serviceTypeName) {
    if (serviceTypeName === serviceTypeFilters.value[0].name) {
        return data;
    }
...
// SORT FUNCTION
const bestRatingfilter = async function () {
    filtered.value = filtered.value.toSorted((a, b) => b.average_rate - a.average_rate);
};
const newestfilter = async function () {
    filtered.value = filtered.value.toSorted((a, b) => getTime(new Date(b.created)) - getTime(new Date(a.created)));
};
const priceLowToHighfilter = async function () {
    filtered.value = filtered.value.toSorted((a, b) => a.price - b.price);
};
const priceHighToLowfilter = async function () {
    filtered.value = filtered.value.toSorted((a, b) => b.price - a.price);
};
// COMPARE FUNCTION
